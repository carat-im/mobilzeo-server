...
driver.get("https://www.yytelecom.co.kr/TelePaymentCtrls/RateListAll/telecom_type:kt")

with open("../csv/" + str(carrierId) + "_yeoyou_kt.csv", "w", newline="") as file:
    ...
    for i in range(2, 8):
        ...
        plans = driver.find_element("xpath", '//*[@id="kt' + str(i) + '"]/div/table/tbody') \
            .find_elements("xpath", '//*[@id="kt' + str(i) + '"]/div/table/tbody/tr')
