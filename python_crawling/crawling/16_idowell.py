...
driver.get("https://www.idowell.co.kr/home/contents.php?sn1=2&sn2=1&page=1")

with open("../csv/" + str(carrierId) + "_idowell.csv", "w", newline="") as file:
    ...
    for i in range(1, 5):
        driver.get("https://www.idowell.co.kr/home/contents.php?sn1=2&sn2=1&page=" + str(i))
        time.sleep(1)

        plans = driver.find_elements(By.XPATH, '//*[@id="contents"]/article/div/div[6]/table/tbody/tr')
