...
driver.get("https://www.sk7mobile.com/prod/data/callingPlanList.do?refCode=PHONE&searchOrderby=1")

with open("../csv/" + str(carrierId) + "_sk7_phone.csv", "w", newline="") as file:
    ...
    for i in range(1, 9):
        if i > 1:
            driver.find_element(By.XPATH, '//*[@id="frm"]/div/div[2]/dl[' + str(i) + ']').click()
        time.sleep(1)

        plans = driver.find_elements(By.XPATH, '//*[@id="frm"]/div/div[2]/dl/dd/div/a')
